            ...
            <table id="tableStudent" class="table table-striped table-bordered" style="width:100%">
                ...
                <c:forEach items="${eList}" var="e">
                    <tr>
                        ...
                        <td><c:out value="${e.employeeDateOfBirth}"/></td>
                        <td><c:out value="${e.employeeIdCard}"/></td>
                        <td><c:out value="${e.employeeSalary}"/></td>
                        <td><c:out value="${e.employeePhoneNumber}"/></td>
                        <td><c:out value="${e.employeeEmail}"/></td>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal-${e.employeeId}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are you sure to delete Customer Id ${e.employeeId} and Name ${e.employeeName}
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <a href="/employee?actionUser=delete&did=${e.employeeId}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </div>
                            </div>
                        </div>
                    </div>
